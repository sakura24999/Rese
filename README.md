...
・会員登録（Fortifyを使用）
![会員登録機能](./assets/登録.mov)

・ログイン
![ログイン機能](./assets/ログイン.mov)
...
・ユーザー飲食店お気に入り一覧取得
![お気に入り機能](./assets/ログイン後（お気に入り）.mov)

・ユーザー飲食店予約情報取得
・飲食店一覧取得
![ホーム画面](./assets/Home（ログイン前）.mov)
...
・飲食店予約情報追加
![予約機能](./assets/予約機能.mov)

・飲食店予約情報削除
![予約キャンセル](./assets/キャンセル.mov)
...
![評価機能](./assets/評価機能.mov)

・マイページの予約状況から「予約日」「時間」「人数」の変更が可能
![予約変更](./assets/予約変更.mov)

・マイページの予約状況からORコードの発行が可能
![QRコード](./assets/QRコード.mov)
...
![メール認証](./assets/メール認証.mov)

#### その他

・モーダルウィンドウ機能
![モーダルウィンドウ](./assets/モーダルウィンドウ.mov)

・決済機能
![決済機能](./assets/決済機能.mov)
